...
Download `boreal-v1.2.4-windows-x86_64.exe` from the
[BOREAL download table](../README.md#install-boreal).

## 2. Start BOREAL

1. Open the **Downloads** folder.
2. Double-click `boreal-v1.2.4-windows-x86_64.exe`.
...
```powershell
Get-FileHash .\boreal-v1.2.4-windows-x86_64.exe -Algorithm SHA256
```
