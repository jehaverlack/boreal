...
- Apple M1, M2, M3, or later: download `boreal-v1.2.3-macos-aarch64`.
- Intel processor: download `boreal-v1.2.3-macos-x86_64`.
...
```bash
cd ~/Downloads
chmod +x boreal-v1.2.3-macos-aarch64
```
...
```bash
cd ~/Downloads
chmod +x boreal-v1.2.3-macos-x86_64
```
...
```bash
./boreal-v1.2.3-macos-aarch64
```

Intel:

```bash
./boreal-v1.2.3-macos-x86_64
```
...
```bash
xattr -d com.apple.quarantine boreal-v1.2.3-macos-aarch64
./boreal-v1.2.3-macos-aarch64
```
...
```bash
shasum -a 256 boreal-v1.2.3-macos-aarch64
```
