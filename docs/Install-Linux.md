...
- `x86_64`: download `boreal-v1.2.2-linux-x86_64`.
- `aarch64` or `arm64`: download `boreal-v1.2.2-linux-aarch64`.
- `armv7l`: download `boreal-v1.2.2-linux-armv7`.
...
```bash
cd ~/Downloads
chmod +x boreal-v1.2.2-linux-x86_64
```
...
```bash
sha256sum boreal-v1.2.2-linux-x86_64
```
